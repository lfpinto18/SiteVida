...
var simpleGallery_navpanel={
	loadinggif: 'botoes/ajaxload.gif', //full path or URL to loading gif image
	panel: {height:'45px', opacity:0.5, paddingTop:'5px', fontStyle:'bold 11px Verdana'}, //customize nav panel container
	images: [ 'botoes/left.gif', 'botoes/play.gif', 'botoes/right.gif', 'botoes/pause.gif'], //nav panel images (in that order)
